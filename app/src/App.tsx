...
// Inner component so hooks can access wallet/connection providers
function AppContent() {
  const { vault, loading, refresh } = useAsset();
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <AssetCard vault={vault} loading={loading} />
          <InvestForm vault={vault} onSuccess={refresh} />
        </div>

        {/* Portfolio */}
        <Portfolio onClaimed={refresh} />
      </main>
